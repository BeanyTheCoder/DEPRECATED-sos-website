...
!(function () {
  ...
  function t(i, s) {
    void 0 === i && (i = {}),
      ...
      Object.keys(s).forEach((r) => {
        void 0 === i[r]
          ? (i[r] = s[r])
          : e(s[r]) && e(i[r]) && Object.keys(s[r]).length > 0 && t(i[r], s[r]);
      });
  }
  const i = {
    body: {},
          ...
          void 0 !== n &&
            ...
            (d(e[r]) && d(s[r])
              ? s[r].__swiper__
                ...
                : p(e[r], s[r])
              : !d(e[r]) && d(s[r])
              ? ((e[r] = {}), s[r].__swiper__ ? (e[r] = s[r]) : p(e[r], s[r]))
              : (e[r] = s[r]));
        }
      }
    }
  ...
  function h(e) {
    ...
    const c = i > a ? "next" : "prev",
      ...
      u = () => {
        ...
        let c = a + n * (i - a);
        if ((p(c, i) && (c = i), t.wrapperEl.scrollTo({ [s]: c }), p(c, i)))
          return (
    ...
    updateSlides: function () {
      ...
      for (let r = 0; r < h; r += 1) {
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            (k = (a - (s.slidesPerView - 1) * y) / s.slidesPerView),
              s.roundLengths && (k = Math.floor(k)),
      ...
      if (
        ...
        o &&
          ...
          (r.style.width = `${e.virtualSize + s.spaceBetween}px`),
        s.setWrapperSize &&
          (r.style[t("width")] = `${e.virtualSize + s.spaceBetween}px`),
        M && e.grid.updateWrapperSize(k, v, t),
        !s.centeredSlides)
      ) {
        const t = [];
      ...
      if (d && s.loop) {
        ...
        if (s.slidesPerGroup > 1) {
          ...
          for (let e = 0; e < i; e += 1) v.push(v[v.length - 1] + r);
        }
        for (
          let i = 0;
          ...
          1 === s.slidesPerGroup && v.push(v[v.length - 1] + t),
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < s.length; e += 1) {
        ...
        const d =
          ...
          c =
            (a - n[0] + (i.centeredSlides ? t.minTranslate() : 0) - l) /
            (o.swiperSlideSize + i.spaceBetween),
          p = -(a - l),
  ...
  var L = {
    slideTo: function (e, t, i, s, r) {
      ...
      if ((n.animating && o.preventInteractionOnTransition) || (!m && !s && !r))
        return !1;
      ...
      if (
        ...
        return (
          ...
          "reset" !== A && (n.transitionStart(i, A), n.transitionEnd(i, A)),
          !1
        );
      if (o.cssMode) {
        const e = n.isHorizontal(),
        ...
        if (0 === t) {
          ...
          if (!n.support.smoothScroll)
            return (
              h({ swiper: n, targetPosition: i, side: e ? "left" : "top" }), !0
            );
        ...
        (r = parseInt(
          ...
          t.centeredSlides
            ? n < e.loopedSlides - s / 2 ||
              ...
              ? (e.loopFix(),
                (n = e.getSlideIndex(
                  f(i, `${o}[data-swiper-slide-index="${r}"]`)[0]
                )),
                a(() => {
                  e.slideTo(n);
                }))
  ...
  function G(e) {
    const t = s(),
      i = this,
      r = i.touchEventsData,
      { params: n, touches: a, rtlTranslate: l, enabled: d } = i;
    if (!d) return;
          ...
          r.currentTranslate > i.minTranslate() &&
            ...
            n.resistance &&
              (r.currentTranslate =
                i.minTranslate() -
                1 +
                (-i.minTranslate() + r.startTranslate + g) ** E)))
        : g < 0 &&
          (b &&
            !S &&
            r.currentTranslate <
          ...
          r.currentTranslate < i.maxTranslate() &&
            ...
            n.resistance &&
              (r.currentTranslate =
                i.maxTranslate() +
                1 -
                (i.maxTranslate() - r.startTranslate - g) ** E))),
  ...
  const $ = {
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          u && i && e.changeDirection(), p(e.params, o);
  ...
  class q {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: i } = this,
        s = v(f(t, `.${i.slideClass}, swiper-slide`)[0]);
      return v(e) - s;
    }
  ...
  function te(e) {
    ...
    U(t, R);
    const s = [...Q, "on"],
      r = s.map((e) => e.replace(/_/, ""));
    return (
      s.forEach((t) => {
        (t = t.replace("_", "")), void 0 !== e[t] && (i[t] = e[t]);
      }),
      [...e.attributes].forEach((e) => {
        const t = ee.filter((t) => 0 === e.name.indexOf(`${t}-`))[0];
        if (t) {
          const s = K(t),
            r = K(e.name.split(`${t}-`)[1]);
          i[s] || (i[s] = {}),
            !0 === i[s] && (i[s] = { enabled: !0 }),
            (i[s][r] = J(e.value));
        } else {
          ...
          const s = J(e.value);
          i[t] && ee.includes(e.name)
            ? (i[t].constructor !== Object && (i[t] = {}), (i[t].enabled = s))
            : (i[t] = s);
        }
      }),
      U(t, i),
  ...
  function ie(e) {
    ...
    if (
      ...
      r.includes("children") &&
        ...
        f &&
        c.virtual.enabled &&
        ((f.slides = i), f.update(!0)),
      r.includes("children") && i && c.loop && (E = !0),
      v)
    ) {
      m.init() && m.update(!0);
    }
  ...
  let re = !0;
  const ne = (e, t) => {
    let i = document.querySelector("style#swiper-element-styles");
    const s = i && i.preInit && !e;
    !e &&
      t &&
      ...
      (i && !s) ||
        ...
        (i.textContent = [se, t ? t.cssStyles() : ""].join("\n")),
        (i.id = "swiper-element-styles"),
        (i.preInit = e),
  ...
  class oe extends ae {
    ...
    initialize() {
      ...
      this.initialized = !0;
      const { params: t, passedParams: i } = te(this);
      (this.swiperParams = t),
        (this.passedParams = i),
        ...
        (this.swiper = new q(this, {
          ...
          onAny: function (i) {
            const s = t.eventsPrefix
              ? `${t.eventsPrefix}${i.toLowerCase()}`
              : i.toLowerCase();
            for (
